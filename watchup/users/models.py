...
class UserManager(BaseUserManager):
    def create_user(self, user_id, password, email, hp, name, student_id, grade, auth, **extra_fields):
        user = self.model(
            user_id = user_id,
            email = email,
            hp = hp,
    ...
    def create_superuser(self, user_id, password, email=None, hp=None, name=None, student_id=None, grade=None, auth=None):
        user = self.create_user(user_id, password, email, hp, name, student_id, grade, auth)
